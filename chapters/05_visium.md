...
sequenced, and how many genes you actually saw. *Real Visium HD data from
...
far fewer of them and each one blends more cells together. *Real Visium HD data from
Dr. Remi Adelaiye-Ogala's lab, University at Buffalo.*
```
